...
- **Guiding Principle:** Defense-system subtypes, OMP receptor variants, capsule/LPS detail, and phylogenomic embeddings
  for host strains.
- [ ] Build defense-system subtype feature block from defense_finder annotations
...
- [ ] Build RBP-receptor compatibility features from curated genus-receptor lookup
...
- **Guiding Principle:** LightGBM model on expanded genomic features with calibration, ablation, and SHAP
  interpretation.
- [ ] Train LightGBM binary classifier on v1 expanded feature set
