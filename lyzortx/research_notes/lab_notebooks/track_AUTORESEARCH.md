...
**Pairwise RBP × receptor cross-terms (AX03) improve top-3 but not AUC.** The 24 cross-terms boost top-3 from 94.6%
...
force the model to attend to specific phage-has-RBP × host-has-receptor combinations.
...
- **AX03**: Plan called for structural cluster → receptor class mapping. Implemented simpler RBP presence × receptor
