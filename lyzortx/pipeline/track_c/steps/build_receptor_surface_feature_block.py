...
FEATURE_DEFINITIONS: Dict[str, Dict[str, object]] = {
    ...
    "host_k_antigen_proxy_present": {
        ...
        "type": "binary",
        "source_paths": ["data/genomics/bacteria/picard_collection.csv"],
        "source_columns": ["Klebs_capsule_type", "ABC_serotype", "Capsule_ABC", "Capsule_GroupIV_e", "Capsule_GroupIV_e_stricte", "Capsule_GroupIV_s", "Capsule_Wzy_stricte"],
    ...
    "host_receptor_tonB_present": {
        ...
        "note": "The repository contains no TonB locus table analogous to the OMP cluster source.",
    },
    "host_receptor_tonB_variant": {
        "group": "receptor",
        "type": "categorical",
