#!/usr/bin/env python3
"""TK05: Measure the cumulative lift from adding confidence-weighted Tier B supervision."""
...
DEFAULT_OUTPUT_DIR = Path("lyzortx/generated_outputs/track_k/tk05_tier_b_lift_measurement")
CURRENT_SOURCE_SYSTEMS = ("virus_host_db", "ncbi_virus_biosample")
CURRENT_SOURCE_LABEL = "tier_b"
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    augmented_source_systems = [*base_source_systems, *CURRENT_SOURCE_SYSTEMS]
    ...
    summary_filename = "tk05_tier_b_lift_summary.csv"
    rankings_filename = "tk05_tier_b_holdout_top3_rankings.csv"
    manifest_path = args.output_dir / "tk05_tier_b_lift_manifest.json"
    ...
    write_output_tables(
        ...
        manifest_payload={
            ...
            "step_name": "build_tier_b_lift_report",
            "source_system_added": CURRENT_SOURCE_LABEL,
            ...
            "input_paths": {
                ...
                "tk04_manifest": str(args.tk04_manifest_path),
            },
            "input_hashes_sha256": {
                ...
                **({"tk04_manifest": sha256(args.tk04_manifest_path)} if args.tk04_manifest_path.exists() else {}),
            },
            "previous_best_source_systems": previous_best_source_systems,
            "best_source_systems": (
                [*previous_best_source_systems, *CURRENT_SOURCE_SYSTEMS]
